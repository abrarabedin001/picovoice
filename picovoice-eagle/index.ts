...
try {
  ...
  if (enrollPercentage < 100) {
    ...
    let recognizeWaveBuffer = fs.readFileSync("./output/longest_segment_1_0.3199999928474426_3.479999989271164.wav");
    ...
    for (let profilePath of ["./output/longest_segment_1_0.3199999928474426_3.479999989271164.wav"]) {
